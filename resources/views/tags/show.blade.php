...
@section('title', 'Вакансии по тегу '.$tag->title)
@section('content')
    <div class="main-wrap">
            ...
            <section class="content">
                ...
                <div class="container-content-header">
                    <div class="wrap-count-vacancy">
                        <div class="count-vacancy"><b>{{$rowCountVacs}} по тегу
                                <span class="tag-title">#{{str_replace(' ', '_', $tag->title)}}</span></b></div>
                    </div>
                    <div class="wrap-sort">
                ...
                <div class="container-vacancy mb-5">
                    ...
                    @if (count($vacs))
                        ...
                        @endforeach
                    @else
                        <p>Вакансий по тегу не найдено</p>
                    @endif
                </div>
                <!-- /.card -->
            </section>
